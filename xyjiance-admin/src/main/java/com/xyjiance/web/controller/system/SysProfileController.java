...
import com.xyjiance.common.utils.file.FileUploadUtils;
import com.xyjiance.common.utils.file.FileUtils;
import com.xyjiance.common.utils.file.MimeTypeUtils;
import com.xyjiance.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(XyJianceConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(XyJianceConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
