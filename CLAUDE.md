...
- 启动: 运行 `xyjiance-admin/src/main/java/com/xyjiance/XyJianceApplication.java` 的 main 方法
...
**数据库:**
- 脚本: `sql/ry_20260417.sql`（主库）、`sql/ry_20260608_company.sql`（集团架构）、`sql/ry_20260608_wx.sql`（微信）
- 按顺序导入: 主库 → company → wx
